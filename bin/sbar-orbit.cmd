...
:preflight
shift
"%orbit_bun%" run "%orbit_root%\scripts\preflight.ts" %1 %2 %3 %4
exit /b %errorlevel%

:serve
shift
"%orbit_bun%" run "%orbit_root%\scripts\limited.ts" "%orbit_bun%" run "%orbit_root%\src\cli.ts" serve %1 %2 %3 %4
exit /b %errorlevel%
...
"%orbit_bun%" run "%orbit_root%\src\cli.ts" status %1 %2 %3 %4
exit /b %errorlevel%

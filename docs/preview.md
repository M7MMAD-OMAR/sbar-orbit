...
The viewer paints from Orbit's own design system: one fixed dark palette, one elevation scale, one spacing scale. See [viewer design](viewer-design.md) for the tokens and what each rank of elevation is for.
